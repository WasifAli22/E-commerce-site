            ...
            <div className="grid grid-cols-6 m-auto">
                <div className="col-span-12 m-auto relative">
                    ...
                    <div className="flex items-center">
                        <Input type="email" placeholder='Input email address' className='relative border shrink-[2] focus:border-0 focus:outline-none border-[gray] border-solid h-[42px] py-[10px] pr-0 lg:pr-[120px] pl-[20px]' />
